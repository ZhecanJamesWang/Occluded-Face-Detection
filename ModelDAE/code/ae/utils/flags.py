...
def home_out(path):
  return pjoin(os.environ['HOME'], 'tensorflowADE', 'custom', path)
...
flags.DEFINE_float('noise_1', 0, 'Rate at which to set pixels to 0')
flags.DEFINE_float('noise_2', 0, 'Rate at which to set pixels to 0')
flags.DEFINE_float('noise_3', 0, 'Rate at which to set pixels to 0')

# Constants
flags.DEFINE_integer('seed', 1234, 'Random seed')
flags.DEFINE_integer('image_size', size, 'Image square size')
