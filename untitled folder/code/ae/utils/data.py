...
def read_data_sets(train_dir, fake_data=False, one_hot = True):
  ...
  # train_images = extract_images(local_file)[:1000]

  # local_file = maybe_download(TRAIN_LABELS, train_dir)
  # train_labels = extract_labels(local_file, one_hot=one_hot)[:1000]


  # local_file = maybe_download(TEST_IMAGES, train_dir)
  # test_images = extract_images(local_file)[:1000]

  # local_file = maybe_download(TEST_LABELS, train_dir)
  # test_labels = extract_labels(local_file, one_hot=one_hot)[:1000]


##############

  train_images = pickle.load( open( dataDir + "xTrain.p", "rb" ) )[:1000]
  train_labels = pickle.load( open( dataDir + "yTrain.p", "rb" ) )[:1000]
  test_images  = pickle.load( open( dataDir + "xTest.p", "rb" ) )[:2000]
  test_labels = pickle.load( open( dataDir + "yTest.p", "rb" ) )[:2000]
...
##############
  ...
  test_images  = pickle.load( open( dataDir + "xTest.p", "rb" ) )[:1000]
